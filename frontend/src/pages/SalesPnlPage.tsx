...
const saleExportColumns: ExportColumn<UnitSaleAllocation>[] = [
  ...
  { header: "Net m²", value: (r) => (r.net_m2 != null ? Number(r.net_m2) : "") },
  { header: "Brüt m²", value: (r) => (r.gross_m2 != null ? Number(r.gross_m2) : "") },
  { header: "Alıcı", value: (r) => r.buyer_name ?? "" },
  { header: "Satış (TRY)", value: (r) => toNumber(r.sale_price_try) },
  { header: "Satış (USD)", value: (r) => (r.sale_price_usd != null ? Number(r.sale_price_usd) : "") },
  { header: "Maliyet Payı (USD)", value: (r) => (r.unit_cost_usd != null ? Number(r.unit_cost_usd) : "") },
  { header: "Kar/Zarar (TRY)", value: (r) => (r.pnl_try != null ? Number(r.pnl_try) : "") },
  { header: "Marj (%)", value: (r) => (r.margin_pct != null ? Number(r.margin_pct) : "") },
  { header: "Tarih", value: (r) => (r.sale_date ? formatDate(r.sale_date) : "") },
